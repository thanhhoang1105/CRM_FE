...
import ActivitiesInBoardEdit from './activities';
import ContactInBoardEdit from './contact';
import ScheduleInBoardEdit from './schedule';
...
const BoardEdit = () => {
    ...
    return (
        <DetailContent rootClassName="board_detail-content">
            <DetailHeader pageTitle={pathnames.boardManagement.edit.name} buttons={buttons} goBack={goBack} />
            ...
            <div className="box-content-container">
                ...
                <ContactInBoardEdit id={id} />
                <ScheduleInBoardEdit id={id} />
