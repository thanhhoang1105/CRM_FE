...
import contactManagementRoute from './contact-management';
...
const routes: IRoute[] = [homeRoute, ...boardManagementRoute, ...opportunityManagementRoute, ...contactManagementRoute, notFoundRoute, loginRoute];
